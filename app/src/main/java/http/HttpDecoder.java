...
import utils.EasySSLSocketFactory;
...
public class HttpDecoder {
	...
	private static final String APISTORE_APIKEY = "9ddab0a07f9e0a30c8db0478182e953e";
	...
	private static String getEncodedGetUri(String uri,
		...
		if (params == null || uri == null||params.size()==0) {
			return uri;
		}
...
//						.getEntity().getContent(), clz);
	...
	private static HttpURLConnection getConnection(String url,
		...
		conn.setRequestProperty("apikey", APISTORE_APIKEY);
		return conn;
	}
